...
IOStatus ZoneFsBackend::ExplicitOpen([[maybe_unused]]uint64_t start, [[maybe_unused]]bool mode) {
  // Not implemented yet
  return IOStatus::OK();
}

IOStatus ZoneFsBackend::Copy([[maybe_unused]]uint64_t dst, [[maybe_unused]]uint64_t src,
